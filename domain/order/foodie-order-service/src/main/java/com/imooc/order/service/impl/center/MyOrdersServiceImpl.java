...
import comm.imooc.order.mapper.OrdersMapperCustom;
...
public class MyOrdersServiceImpl extends BaseService implements MyOrdersService {
    ...
    @Override
    public PagedGridResult queryMyOrderList(String userId,
                                            String orderStatus,
                                         Integer page,
                                         Integer pageSize) {
...
//    }
    ...
    @Transactional(propagation= Propagation.REQUIRED)
    @Override
    public boolean updateDeleteOrder(String userId, String orderId) {
